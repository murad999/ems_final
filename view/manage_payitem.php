            ...
            <div class="col-lg-6">
              <div id="payitems_table">
                <table class="table">
                  ...
                  <tbody>
                  <hr>
                <?php while ($row = $payitems->FETCH_ASSOC()): //print_r($row);?>
                  <tr>
                    <td><?php echo $row['name']; ?></td>
                     <td>
                         <a href="?page=view/edit_payitem.php&id=<?php echo $row['id'] ?>"  class="btn btn-info" >
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
           <div class="row">
                <div class="col-md-8">
                  <form role="form" action="" method="post" id="payItem">
